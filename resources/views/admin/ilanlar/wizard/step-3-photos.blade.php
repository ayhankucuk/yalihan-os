        ...
        <div @dragover.prevent="dragging = true" @dragleave.prevent="dragging = false"
            ...
            <div class="space-y-4">
                <div class="flex flex-col items-center gap-4">
                    <div
                        class="w-16 h-16 bg-[#C9A84C]/15 dark:bg-[#C9A84C]/10 rounded-full flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <label for="fotograflar"
                            class="text-[#C9A84C] font-bold cursor-pointer hover:underline">
                            Dosya Seçin
                        </label>
                    </div>
