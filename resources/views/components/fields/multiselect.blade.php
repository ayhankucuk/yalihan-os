            ...
            @foreach($field['options'] as $option)
                <button type="button"
                    ...
                    <span class="transition-transform duration-200"
                        ...
                        <svg x-show="selected.includes('{{ $option['value'] }}')" class="h-3.5 w-3.5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                        </svg>
                        <svg x-show="!selected.includes('{{ $option['value'] }}')" class="h-3.5 w-3.5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
