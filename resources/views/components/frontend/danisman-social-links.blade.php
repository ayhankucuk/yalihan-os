...
@php
    ...
    // SVG brand icons (Material Symbols'ta bulunmayan brand ikonlar için inline SVG)
    $socialSvgs = [
        ...
        'twitter' => '<svg viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.259 5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>',
            ...
            @if($variant === 'outline' || $variant === 'minimal')
                <a href="{{ $link['url'] }}"
                   ...
                   aria-label="{{ $link['label'] }}">
                    @if(isset($socialSvgs[$link['icon']]) && $socialSvgs[$link['icon']])
                        {!! $socialSvgs[$link['icon']] !!}
                    @else
