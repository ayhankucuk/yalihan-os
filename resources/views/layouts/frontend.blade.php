...
<body
    ...
    <nav class="fixed top-9 w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-sm h-20 font-sans">
        <div class="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center h-full">
            <div class="flex items-center gap-12">
                ...
                <div class="hidden md:flex gap-8">
                    <a class="{{ request()->routeIs('konut') ? 'text-primary font-semibold' : 'text-on-surface-variant font-medium' }} hover:text-primary transition-all duration-300" href="{{ route('konut') }}">Konut</a>
                    <a class="{{ request()->routeIs('arsa') ? 'text-primary font-semibold' : 'text-on-surface-variant font-medium' }} hover:text-primary transition-all duration-300" href="{{ route('arsa') }}">Arsa</a>
                    <a class="{{ request()->routeIs('villas.*') ? 'text-primary font-semibold' : 'text-on-surface-variant font-medium' }} hover:text-primary transition-all duration-300" href="{{ route('villas.index') }}">Yazlık</a>
                    <a class="{{ request()->routeIs('ilanlar.international') ? 'text-primary font-semibold' : 'text-on-surface-variant font-medium' }} hover:text-primary transition-all duration-300" href="{{ route('ilanlar.international') }}">Uluslararası</a>
                    <a class="{{ request()->routeIs('frontend.danismanlar.*') ? 'text-primary font-semibold' : 'text-on-surface-variant font-medium' }} hover:text-primary transition-all duration-300" href="{{ route('frontend.danismanlar.index') }}">Danışmanlar</a>
                </div>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                @auth
                    <a href="{{ route('admin.dashboard.index') }}" class="bg-primary text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-blue-700 active:scale-[0.99] transition-all flex items-center gap-2">
                        <x-icon name="kullanici" class="w-4 h-4" /> Panel
                    </a>
                @else
                    <a href="{{ route('login') }}" class="bg-primary text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-blue-700 active:scale-[0.99] transition-all flex items-center gap-2">
                        <x-icon name="kilit" class="w-4 h-4" /> Giriş Yap
                    </a>
                @endauth
        ...
        <div id="mobileMenu" class="hidden py-4 md:hidden bg-white border-t border-slate-100 shadow-lg absolute w-full left-0 top-20">
            <div class="flex flex-col gap-1 px-4">
                <a href="{{ route('home') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('home') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">Ana Sayfa</a>
                <a href="{{ route('konut') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('konut') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">Konut</a>
                <a href="{{ route('arsa') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('arsa') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">Arsa</a>
                <a href="{{ route('villas.index') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('villas.*') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">Yazlık Kiralık</a>
                <a href="{{ route('ilanlar.international') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('ilanlar.international') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">Uluslararası</a>
                <a href="{{ route('frontend.danismanlar.index') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('frontend.danismanlar.*') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">Danışmanlar</a>
                <a href="{{ route('contact') }}" class="rounded-lg px-4 py-3 text-sm font-medium hover:bg-surface-container-low {{ request()->routeIs('contact') ? 'text-primary bg-surface-container-low' : 'text-on-surface' }}">İletişim</a>
            </div>
        </div>
    </nav>

    <!-- Main Content — topbar(36px) + nav(80px) = 116px offset -->
    <main class="min-h-screen" style="padding-top:116px">
        @yield('content')
    </main>
            ...
            <div class="mb-12 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('villas.index') }}" class="footer-link text-sm">Yazlık Kiralık</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="{{ route('arsa') }}" class="footer-link text-sm">Arsa &amp; Arazi</a></li>
