...
@section('content')
    <div class="space-y-6" x-data="ilanFilter()">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="group relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg dark:hover:shadow-slate-950/50 transition-all duration-300 overflow-hidden">
                ...
                <div class="relative flex items-center gap-4">
                    <div class="w-12 h-12 bg-blue-50 dark:bg-blue-900/20 rounded-xl flex items-center justify-center text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300">
            ...
            {{-- Bu Ay --}}
            <div class="group relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg dark:hover:shadow-slate-950/50 transition-all duration-300 overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-br from-purple-50/50 to-transparent dark:from-purple-900/10 dark:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="relative flex items-center gap-4">
                    <div class="w-12 h-12 bg-purple-50 dark:bg-purple-900/20 rounded-xl flex items-center justify-center text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300">
            ...
            {{-- Bekleyen İlanlar --}}
            <div class="group relative bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-6 hover:shadow-lg dark:hover:shadow-slate-950/50 transition-all duration-300 overflow-hidden">
                <div class="absolute inset-0 bg-gradient-to-br from-orange-50/50 to-transparent dark:from-orange-900/10 dark:to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="relative flex items-center gap-4">
                    <div class="w-12 h-12 bg-orange-50 dark:bg-orange-900/20 rounded-xl flex items-center justify-center text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform duration-300">
        ...
        {{-- İlan Listesi --}}
        <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md dark:hover:shadow-slate-950/30 transition-shadow duration-300">
            <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <x-icon name="liste" class="w-5 h-5 text-slate-400 dark:text-slate-500" />
                    <h3 class="text-base font-black text-slate-900 dark:text-white uppercase tracking-tighter">{{ __('admin.listing_list') }}</h3>
                </div>
                <span class="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-xs font-black uppercase tracking-widest rounded-full"
                    x-text="`${totalCount} {{ __('admin.listing') }}`">{{ $ilanlar->total() }} {{ __('admin.listing') }}</span>
            </div>
                                        ...
                                        <td class="px-6 py-8">
                                            <div class="flex flex-col gap-4">
                                                ...
                                                <div class="flex items-center gap-3">
                                                   ...
                                                   {{-- 🧠 Nöral Telemetri --}}
                                                   <div class="flex items-center gap-1.5 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded-full border border-slate-200 dark:border-slate-700">
                                                       @if ($ilan->islendi)
                                                           <span class="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]"></span>
                                                       @endif
                                                       {{-- Yayin Durumu Mini Badge --}}
                                                       @php $ilanDurumu = $ilan->yayin_durumu ?? 'taslak'; @endphp
                                                       @if ($ilanDurumu === 'satildi')
                                                           <span class="inline-flex items-center gap-1 text-[9px] font-black uppercase tracking-widest text-blue-600 dark:text-blue-400">
                                                               <x-icon name="onay-daire" class="w-3 h-3" /> Satıldı
                                                           </span>
                                                       @elseif ($ilanDurumu === 'kiralandi')
                                                           <span class="inline-flex items-center gap-1 text-[9px] font-black uppercase tracking-widest text-purple-600 dark:text-purple-400">
                                                               <x-icon name="kilit" class="w-3 h-3" /> Kiralandı
                                                           </span>
                                                       @elseif ($ilan->islendi)
                                                           <span class="text-[9px] font-black uppercase tracking-widest text-emerald-600 dark:text-emerald-400">İŞLENDİ</span>
                                                       @endif
                                                   </div>
                                               </div>
                                               ...
                                               <div class="flex items-start gap-5">
                                                   <div class="relative flex-shrink-0 group/img">
                                                       <div class="absolute -inset-1 bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl blur opacity-25 group-hover/img:opacity-50 transition duration-500"></div>
                                                       <div class="relative w-48 h-32 rounded-xl overflow-hidden shadow-2xl border-2 border-white dark:border-slate-800">
                                                           @php
                                                           ...
                                                           @else
                                                               <div class="w-full h-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
                                                                   <x-icon name="resim" class="w-10 h-10 text-slate-300 dark:text-slate-600" />
                                                               </div>
                                                           @endif
                                                           {{-- Price Overlay on Hover --}}
                                                           <div class="absolute inset-0 bg-slate-900/60 flex items-center justify-center opacity-0 group-hover/img:opacity-100 transition-opacity duration-300 backdrop-blur-sm">
                                                               <span class="text-white font-black text-sm tracking-tighter">İNCELE</span>
                                                           </div>
                                                       </div>
                                                   </div>

                                                   <div class="flex-1 space-y-3">
                                                       <div class="flex items-center gap-2 text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-widest">
                                                           <x-icon name="konum" class="w-4 h-4 text-orange-500" />
                                                           {{ $ilan->il->il_adi ?? '-' }}, {{ $ilan->ilce->ilce_adi ?? '-' }}
                                                       </div>
                                                       @if ($ilan->ilanSahibi)
                                                           <div class="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 dark:bg-slate-800/50 rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-500 border border-slate-200 dark:border-slate-700">
                                                       ...
                                                       @if ($ilan->anahtar_notlari)
                                                           <p class="text-xs text-slate-500 dark:text-slate-400 line-clamp-2 italic font-serif leading-relaxed">
                                                               "{{ \Illuminate\Support\Str::limit($ilan->anahtar_notlari, 120) }}"
                                                           </p>
                                                       @endif
                                                   </div>
                                               </div>
                    ...
                    <div class="flex flex-col items-center justify-center py-20 px-6 text-center">
                        <div class="relative mb-6">
                            <div class="w-20 h-20 bg-slate-100 dark:bg-slate-800 rounded-2xl flex items-center justify-center">
                                <x-icon name="bina" class="w-10 h-10 text-slate-300 dark:text-slate-600" />
                            </div>
                            <div class="absolute -top-1 -right-1 w-6 h-6 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center">
                                <x-icon name="arama" class="w-3 h-3 text-orange-500" />
                            </div>
                        </div>
                        <h3 class="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tighter mb-2">
                            {{ __('admin.no_listings_found') }}
                        </h3>
                        <p class="text-sm text-slate-400 dark:text-slate-500 font-medium max-w-xs mb-8">
                            Arama kriterlerinize uygun ilan bulunmamaktadır.
                        </p>
                        <a href="{{ route('admin.ilanlar.create-wizard') }}"
                            class="inline-flex items-center gap-2.5 px-6 py-3.5 bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white rounded-xl shadow-lg shadow-orange-500/25 hover:scale-105 active:scale-95 transition-all duration-300 font-black text-sm uppercase tracking-tighter dark:shadow-none">
                            <x-icon name="ekle" class="w-4 h-4" />
                            {{ __('admin.new_listing') }}
                        </a>
                    </div>
    ...
    @push('scripts')
        ...
        {{-- Match Modal --}}
        <div id="match-modal"
            class="fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-sm items-center justify-center z-50 p-4"
            style="display: none;">
            <div class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl dark:shadow-slate-950/80 border border-slate-100 dark:border-slate-800 max-w-2xl w-full overflow-hidden">
                {{-- Modal Header --}}
                <div class="flex items-center justify-between px-6 py-5 border-b border-slate-100 dark:border-slate-800">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center shadow-lg shadow-emerald-500/20">
                            <x-icon name="kullanicilar" class="w-4 h-4 text-white" />
                        </div>
                        <h3 class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-tighter">
                            Müşteri Uyum Detayları
                        </h3>
                    </div>
                    <button onclick="document.getElementById('match-modal').style.display='none'"
                        class="w-8 h-8 flex items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-200">
                        <x-icon name="kapat" class="w-4 h-4" />
                    </button>
                </div>
                {{-- Modal Body --}}
                <div class="p-6 modal-content max-h-[60vh] overflow-y-auto">
                    <div class="flex items-center gap-3 text-slate-400 dark:text-slate-500">
                        <x-icon name="yukleniyor" class="w-4 h-4 animate-spin" />
                        <span class="text-sm font-medium">{{ __('admin.loading') }}</span>
                    </div>
                </div>
            </div>
        </div>
