                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-2 dark:text-slate-300">
                            <span class="material-symbols-outlined text-pink-600 mr-2">photo_camera</span>Instagram
                        </label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-2 dark:text-slate-300">
                            <span class="material-symbols-outlined text-blue-700 mr-2">share</span>LinkedIn
                        </label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-2 dark:text-slate-300">
                            <span class="material-symbols-outlined text-blue-600 mr-2">share</span>Facebook
                        </label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-2 dark:text-slate-300">
                            <span class="material-symbols-outlined text-gray-600 mr-2">language</span>Website
                        </label>
