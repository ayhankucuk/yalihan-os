        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <div class="text-gray-500 text-sm flex items-center gap-2">
                    ...
                    <a href="{{ $customer->linkedin_url }}" target="_blank" class="hover:text-blue-600"><span class="material-symbols-outlined">share</span></a>
                    <a href="{{ $customer->instagram_url }}" target="_blank" class="hover:text-pink-500"><span class="material-symbols-outlined">photo_camera</span></a>
                    <a href="{{ $customer->facebook_url }}" target="_blank" class="hover:text-blue-700"><span class="material-symbols-outlined">share</span></a>
                </div>
            </div>
        </div>
        <!-- Quick Actions -->
