...
<div class="bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-6 lg:p-8">
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2 dark:text-slate-100">
        <span class="material-symbols-outlined text-blue-600 dark:text-blue-400">villa</span>
        Benzer Villalar
    </h2>
               ...
               class="group block bg-gray-50 dark:bg-slate-900 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div class="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div class="w-full h-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                        <span class="material-symbols-outlined text-gray-400" style="font-size:48px">home</span>
                    </div>
                    @endif
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400 mb-2">
                        <span class="material-symbols-outlined mr-1 text-blue-600" style="font-size:16px">location_on</span>
                    ...
                    <div class="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div class="flex items-center gap-1">
                            <span class="material-symbols-outlined" style="font-size:14px">bathtub</span>
        ...
        <div class="text-center mt-8">
            <a href="{{ route('villas.index') }}"
               class="inline-block px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl">
                <span class="material-symbols-outlined mr-2" style="font-size:18px;vertical-align:middle">grid_view</span>
                Tüm Villaları Gör
            </a>
        </div>
    @else
        <div class="text-center py-12 text-gray-500 dark:text-gray-400">
            <span class="material-symbols-outlined mb-3" style="font-size:48px">home</span>
