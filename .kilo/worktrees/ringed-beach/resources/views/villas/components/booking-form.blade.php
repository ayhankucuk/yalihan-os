...
<div x-data="bookingForm({{ json_encode(['villa_id' => $villa->id, 'pricing' => $pricing]) }})"
    ...
    <form @submit.prevent="submitBooking()" class="space-y-4">
        ...
        <button
            ...
            <span x-show="!loading">
                <span class="material-symbols-outlined mr-2" style="font-size:18px;vertical-align:middle">event_available</span>
                Rezervasyon Talebi Gönder
            </span>
            <span x-show="loading">
                <span class="material-symbols-outlined mr-2 animate-spin" style="font-size:18px;vertical-align:middle">progress_activity</span>
                Gönderiliyor...
            </span>
        </button>
    ...
    <div x-show="success"
         ...
         style="display: none;">
        <span class="material-symbols-outlined mr-2" style="font-size:18px;vertical-align:middle">check_circle</span>
    ...
    <div x-show="error"
         ...
         style="display: none;">
        <span class="material-symbols-outlined mr-2" style="font-size:18px;vertical-align:middle">error</span>
