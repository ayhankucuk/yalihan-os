...
```
[ ] SSH erişimi doğrulandı (ssh ubuntu@157.180.116.63)
...
rsync -avz --exclude='.env' --exclude='node_modules' --exclude='vendor' \
    ...
    ubuntu@157.180.116.63:/var/www/yalihan2026/
```
...
rsync -avz --exclude='.env' ... ubuntu@157.180.116.63:/var/www/yalihan2026/
...
**Runbook Versiyonu:** 3.0 (Hetzner)
**SAB Uyumu:** v6.1.1
**Sunucu:** Hetzner CX33 — `157.180.116.63` | 4 vCPU / 8GB RAM / 80GB SSD
**Sonraki İnceleme:** 2026-07-01
