...
@php
    ...
    $variantClasses = [
        ...
        'secondary' => 'bg-gray-100 text-gray-700 hover:bg-gray-200 focus:ring-gray-500 border border-gray-300 dark:text-slate-300',
        ...
        'light' => 'bg-gray-50 text-gray-600 hover:bg-gray-100 focus:ring-gray-400 border border-gray-200 dark:bg-slate-900 dark:border-slate-700',
