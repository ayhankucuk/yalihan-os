                        ...
                        <div class="relative h-64 bg-gradient-to-br from-blue-400 to-purple-600">
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="w-32 h-32 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center dark:bg-slate-900">
                                    <span class="material-symbols-outlined text-gray-400 dark:text-gray-500" style="font-size:72px">person</span>
                                </div>
                            </div>
                            @if ($i <= 2)
                                <div class="absolute top-4 right-4">
                                    <span class="px-3 py-1 bg-yellow-400 text-gray-900 dark:text-black text-xs font-bold rounded-full dark:text-white dark:text-slate-100">
                                        <span class="material-symbols-outlined mr-1" style="font-size:12px;vertical-align:middle;font-variation-settings:'FILL' 1">star</span> TOP DANIŞMAN
                                    </span>
                                </div>
                            @endif
                        </div>
                            ...
                            <div class="flex items-center justify-center mb-4">
                                <div class="flex text-yellow-400">
                                    @for ($j = 1; $j <= 5; $j++)
                                        ...
                                        @else
                                            <span class="material-symbols-outlined" style="font-size:16px;font-variation-settings:'FILL' 0">star</span>
                                        @endif
                                    @endfor
                                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-8 items-center">
                    <div>
                        <h2 class="text-3xl font-bold mb-4">
                            <span class="material-symbols-outlined mr-3" style="font-size:28px;vertical-align:middle">smart_toy</span>
                        ...
                        <ul class="space-y-3 mb-6">
                            <li class="flex items-center">
                                <span class="material-symbols-outlined mr-3 text-green-400" style="font-size:20px">check_circle</span>
                        ...
                        <button
                            ...
                            <span class="material-symbols-outlined mr-2" style="font-size:18px;vertical-align:middle">forum</span>
                    ...
                    <div class="flex justify-center">
                        <div class="relative">
                            <div
                                ...
                                <span class="material-symbols-outlined text-white/80" style="font-size:96px">psychology</span>
                            </div>
                            <div
