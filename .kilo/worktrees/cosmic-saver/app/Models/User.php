...
class User extends Authenticatable
{
     ...
     *
     * NOT: users tablosunda 'role' adında bir string kolonu da bulunmaktadır.
     * Bu accessor, Laravel'in attribute lookupunu bypass ederek
     * belongsTo ilişkisini string kolonu üzerinde önceliklendirir.
     */
    public function getRoleAttribute($value = null): ?Role
    {
