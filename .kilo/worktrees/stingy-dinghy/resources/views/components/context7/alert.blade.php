    ...
    <div class="flex items-start">
        ...
        @if($dismissible)
            <div class="ml-auto pl-3">
                <button type="button" class="inline-flex text-current opacity-70 hover:opacity-100 focus:outline-none" onclick="this.parentElement.parentElement.parentElement.remove()">
