...
## 2026-06-27 | Oturum 48 | Session Naming — Capability-First Convention

### Karar: Capability Odaklı Session İsimlendirmesi

**Önceki:** Sprint 3.4.5 — AI Description Pipeline
**Yeni:** Capability 1 — AI Listing Assistant | Sprint 3.4.5 — AI Description Pipeline

**Format:**
```
Capability 1 — AI Listing Assistant
├── 3.4.1 Portfolio Creation ✅
├── 3.4.2 Photo Management ✅
├── 3.4.3 Readiness Analysis ✅
├── 3.4.4 Recommendations ✅
└── 3.4.5 AI Description Pipeline ⏳
Capability 2 — AI CRM Assistant
Capability 3 — AI Operations Assistant
Capability 4 — AI Finance Assistant
```

**İlk mesaj formatı (State Packet):**
```
STATE
Project: YALIHAN PLATFORM
Capability: Capability 1 — AI Listing Assistant
Sprint: 3.4.5 — AI Description Pipeline
Completed:
  ✅ Portfolio Creation
  ✅ Photo Management
  ✅ Readiness Analysis
  ✅ Deterministic Recommendations
Goal: Build the AI Description Pipeline.
...
Rules:
  ...
  - Minimal changes
  - No docs
  - No commits until verification
  - Domain-first
  - Human approval required before persistence
```

**Kısa alternatif format:**
```
AI Listing Assistant — 3.4.5 Description Pipeline
```
...
**Gerekçe:**
- 6+ ay sonra "ne üzerinde çalışıyorduk" sorusuna tek bakışta cevap
- Capability = iş değeri, Sprint = yönetim detayı
- Hiyerarşi: Capability > Sprint > Task

**Kaynak:** Kullanıcı önerisi — 2026-06-27

---

## 2026-06-27 | Oturum 48 | Human-in-the-Loop AI Deseni — YALIHAN Platform Standardı

### Karar: AI Hiçbir Zaman Doğrudan Veri Yazmaz
...
**Kurallar:**
1. AI output = Draft (hiçbir zaman üretim alanına yazılmaz)
2. Draft = Review'da bekler
3. Human = Onay verir
4. Persist = Onaydan sonra çalışır

**Gerekçe:**
Bu desen sadece ilan açıklamaları için değil, tüm AI üretimleri için geçerli:
- CRM e-postaları
- Müşteri özetleri
- Sözleşme taslakları
- Finans raporları
...
### Sprint 3.4.5 — Backlog Maddeleri (PR Merge Sonrası)

| # | Madde | Öncelik | Açıklama |
|---|-------|---------|-----------|
| 1 | Domain Event'ler | Yüksek | DescriptionApproved, DescriptionRejected |
| 2 | Draft Versioning | Yüksek | v1, v2, v3... karşılaştırma |
| 3 | Prompt/Model Metadata | Orta | prompt_version, provider, model, temperature |
| 4 | LLM Cost & Latency | Orta | Token sayısı, maliyet, gecikme |
| 5 | AI Feedback Loop | Orta | Kullanıcının yaptığı düzenlemeleri ölçmek |

### Gelecek Capability'ler

**Capability 1A:** Generate → Review → Accept
**Capability 1B:** Measure → Learn → Improve (AI kalitesi için geri besleme)
...
| Human Review | ✅ |
| Genişleyebilirlik | ✅ |
| Event Driven Hazırlığı | 🟡 |
| AI Learning | 🟡 |

**Karar:** APPROVE — Merge et

---

**Kaynak:** SAAB Product Review — Sprint 3.4.5 — 2026-06-27

---

## 2026-06-27 | Oturum 48 | Strategic Pivot — Platform Seviyesi

### Karar: YALIHAN OS → YALIHAN PLATFORM

**Artık "özellik ekleyen yazılım" değil, "AI destekli gayrimenkul platformu" inşa ediyoruz.**

### YALIHAN PLATFORM v2.0 Mimari
...
| Capability | Backend | UI | Versioning | Events | Feedback |
|------------|----------|-----|-------------|--------|-----------|
| C1 — AI Listing | ✅ | ⏳ | ⏳ | ⏳ | ⏳ |
| C2 — AI Workforce | 🔲 | 🔲 | 🔲 | 🔲 | 🔲 |
| C3 — Multi-channel | 🔲 | 🔲 | 🔲 | 🔲 | 🔲 |

### Human-in-the-Loop Deseni — Platform Standardı

```
Data → Quality → Recommendations → AI Draft → Human Review → Persist
```
...
### Karar: MVAI Capability Yaklaşımı

**Capability 1:** Minimum Kullanılabilir AI Capability olarak kabul et.
**Geri bildirim:** Gerçek kullanıcılardan gelen geri bildirim, sonraki geliştirmeleri yönlendirecek.

### Merge Sonrası Teknik Backlog (Öncelik Sırası)

| # | Madde | Sebep |
|---|-------|-------|
| 1 | DescriptionApproved/DescriptionRejected Events | Event-driven mimari |
| 2 | Draft Versioning | v1, v2, v3 karşılaştırma |
| 3 | Prompt/Model Metadata | Hangi model, hangi prompt sürümü |
| 4 | LLM Cost & Latency | AI Workforce maliyet takibi |
| 5 | AI Feedback Analytics | Kullanıcı düzenleme oranı |

### Karar: Sprint → Capability Backlog

**Önceki:** Sprint 3.4.6, Sprint 3.5...
**Yeni:** Capability 1 Backlog, Capability 2 Backlog...

---

**Kaynak:** SAAB Strategic Assessment — 2026-06-27
