...
### Session Naming — Capability-First Convention
...
Rules:
  - Discovery first
  - Minimal changes
  - No docs until verification
  - Domain-first
  - Human approval required before persistence
```

**Gerekçe:**
- Capability = iş değeri (ön planda)
- Sprint = yönetim detayı (ikincil)
- 6+ ay sonra tek bakışta anlaşılır
