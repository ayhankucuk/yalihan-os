...
document.addEventListener('alpine:init', () => {
    Alpine.data('portalManager', (ilanId) => ({
        ...
        async loadSyncStatus() {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.status(this.ilanId) : `/api/ilanlar/${this.ilanId}/portals/status`;
        ...
        async syncToPortal(portal) {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.sync(this.ilanId, portal) : `/api/ilanlar/${this.ilanId}/portals/sync/${portal}`;
                const response = await fetch(url, {
                    method: 'POST',
                    headers: {
        ...
        async syncToAllPortals() {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.syncAll(this.ilanId) : `/api/ilanlar/${this.ilanId}/portals/sync-all`;
                const response = await fetch(url, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        async removeFromPortal(portal) {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.remove(this.ilanId, portal) : `/api/ilanlar/${this.ilanId}/portals/${portal}`;
                const response = await fetch(url, {
                    method: 'DELETE',
                    headers: {
                        Accept: 'application/json',
        ...
        async updatePortalPricing() {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.pricing(this.ilanId) : `/api/ilanlar/${this.ilanId}/portals/pricing`;
                const response = await fetch(url, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        async updatePublishSchedule() {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.schedule(this.ilanId) : `/api/ilanlar/${this.ilanId}/portals/schedule`;
                const response = await fetch(url, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
        ...
        async toggleMasterStatus() {
            ...
            try {
                const url = window.APIConfig ? window.APIConfig.admin.portals.masterStatus(this.ilanId) : `/api/ilanlar/${this.ilanId}/portals/master-status`;
                const response = await fetch(url, {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
