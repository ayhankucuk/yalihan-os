...
class AiWalletServiceTest extends TestCase
{
    ...
    {
        $tenant = Tenant::create(['name' => 'Test Tenant 999', 'domain' => 'test999.com', 'durum' => 'active']);
        $tenantId = $tenant->id;
    ...
    {
        $tenant = Tenant::create(['name' => 'Test Tenant 101', 'domain' => 'test101.com', 'durum' => 'active']);
        $tenantId = $tenant->id;
        $amount = 500;
    ...
    {
        $tenant = Tenant::create(['name' => 'Test Tenant 102', 'domain' => 'test102.com', 'durum' => 'active']);
        $tenantId = $tenant->id;
    ...
    {
        $tenant = Tenant::create(['name' => 'Test Tenant 103', 'domain' => 'test103.com', 'durum' => 'active']);
        $tenantId = $tenant->id;
    ...
    public function it_prevents_race_conditions_atomically()
    {
        ...
        $tenant = Tenant::create(['name' => 'Test Tenant 104', 'domain' => 'test104.com', 'durum' => 'active']);
        $tenantId = $tenant->id;
        $this->service->addCredits($tenantId, 1000, 'init');
