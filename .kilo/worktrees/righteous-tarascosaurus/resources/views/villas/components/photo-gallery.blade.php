        ...
        <div class="relative h-[500px] lg:h-[600px] overflow-hidden">
            ...
            <div class="lg:hidden relative h-full">
                ...
                <button @click="prev()"
                    ...
                    <i class="fas fa-chevron-left text-gray-800 dark:text-white dark:text-slate-200"></i>
                </button>
                <button @click="next()"
                    ...
                    <i class="fas fa-chevron-right text-gray-800 dark:text-white dark:text-slate-200"></i>
                </button>
