# Yalıhan Emlak — Proje Bağlam Dosyası v3 (AI Eğitim Referansı)

**Proje:** Yalıhan Emlak — Bodrum Emlak Platformu (PropTech)
**Versiyon:** v3.0.0 | SAB v6.1.1
**Tarih:** 16 Mayıs 2026
**Önceki Versiyon:** v2.0.0 (6 Nisan 2026)
...
| Governance | SAB v6.1.1 + Context7 + Bekçi MCP |
| Orkestrasyon | N8N |
...
AIController / Cortex endpoint
  → YalihanCortex (35+ dep — GOD CLASS)
    → OllamaService | OpenAIService | GeminiService
...
| Server | Port | Amaç |
|--------|------|------|
| `yalihan-bekci-mcp` | 4001 | AI learning & teaching — herzaman uyanık |
| `context7-validator-mcp` | 4002 | Context7 compliance, autofix |
...
- **YalihanCortex God Class:** 30 → **35+ dep** — daha da büyüdü, acil decomposition
...
- 89 başarısız test (CI 724/813 — tam yeşil değil)
...
| Dosya/Kategori | v2 (Nisan) | v3 (Mayıs) |
|----------------|-----------|-----------|
| Controller | 319 | **327** |
| Route dosyası | 59 | **48** |
| Servis | 170+ | **567** |
...
| Model | 130+ | **189** |
| Test | — | **2.066** |
| admin.php satır | 1710 | **1687** |
| Hardcoded JS URL | 240+ | **~120** |
| APIConfig adoption | 3 dosya | **48 dosya** |
| Domain boundary violation | 16 | **16** (2 resolved/accepted) |
| Bekleyen fix | 18 | **15** (3 tamamlandı/kısmen) |
...
*Versiyon: v3.0.0 | SAB v6.1.1 | 16 Mayıs 2026*
