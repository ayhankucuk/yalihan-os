/* SAB Sync: RC2 migrations integrated 2026-09-14 */
...
CREATE TABLE `ilceler` (
  ...
  CONSTRAINT `ilceler_il_id_foreign` FOREIGN KEY (`il_id`) REFERENCES `iller` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
