...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('notification_templates', function (Blueprint $table) {
            ...
            // $table->tinyInteger('state')->default(1)->comment('0=inactive, 1=active (Context7 boolean)');

            // ✅ CONTEXT7: Kolon rename örneği (DB::statement kullan)
            // DB::statement("ALTER TABLE `notification_templates` CHANGE `old_column` `new_column` INT NOT NULL DEFAULT 0");
        });
    }
