...
class Kisi extends BaseModel
{
    ...
    protected $fillable = [
        ...
        'aktiflik_durumu', // ✅ SAB: Kanonik alan adı (context7-ignore)
     ...
     * kisi_id kolonu mevcut değil. Pivot'ta kisiler.user_id alanı üzerinden bağlanır.
     * Kisi modeli user_id'ye sahip olduğundan ownerKey='user_id' kullanılır.
     *
     ...
     *
     * T-FAV-01 FIX (2026-06-24): ilan_favorileri.user_id → users FK ile eşleşir.
     * kisiler.user_id alanı üzerinden pivot bağlantısı kurulur.
     *
     * Pivot kolon: aktiflik_durumu (kanonik — ilan_favorileri.aktiflik_durumu)
     */
     ...
     * Legacy field → aktiflik_durumu (kanonik kolon) // context7-ignore
     *
     * @context7-proxy
     */
