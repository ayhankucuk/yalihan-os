...
class Ilan extends BaseModel
{
    ...
    /**
     * Test-only helper: bypass the property ID guard without direct protected property access.
     * Production encapsulation is preserved — the property remains protected.
     */
