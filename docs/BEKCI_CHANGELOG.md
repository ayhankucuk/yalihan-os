...
### 🎯 Hedef
AI Vision capability — ilk intelligent media understanding layer. Sprint 6.3 Media Intelligence üzerine AI Vision eklemek.
...
| `app/Jobs/AnalyzeVisionJob.php` | Queue job (async, idempotent, 3 tries, 60s backoff, 180s timeout) |
